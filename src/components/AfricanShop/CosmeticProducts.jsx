                ...
                <div className='container mx-auto px-4 lg:px-0'>
                    <div className="flex flex-col justify-between">
                        ...
                        <div className="flex -mx-4 flex-wrap md:overflow-x-scroll">{/** overflow-x-scroll*/}
                            <Link to={'/product-details'}  className="w-full lg:w-1/5 px-4 md: ">{/**md:grid md:grid-rows-4 md:grid-flow-col md:gap-4 */}
                                <div className="bg-white p-4 flex flex-col mb-10 items-center relative">{/** bg-orange-500 my-4 lg:my-0  */}
                                    ...
                                    <span className="self-end mb-2 text-xl lg:text-2xl text-red-600 font-bold">{"14"}€</span>
