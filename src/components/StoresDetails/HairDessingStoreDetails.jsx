...
import coiffureBgImg from '../../images/cheveux-client.jpg'
import RecommendedProducts from '../RecommendedProducts/RecommendedProducts'
import StoreDetails from './StoreDetails'
import AvailableProducts from '../AvailableProducts/AvailableProducts'

function HairDessingStoreDetails() {
    return (
        <>
            <section className="store-details mt-0">
                <div>
                    <img className="w-full h-[60vh] object-cover" src={coiffureBgImg} alt="" />
                </div>
...
export default HairDessingStoreDetails;